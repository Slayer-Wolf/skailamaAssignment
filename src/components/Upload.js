		...
		<div className="flex flex-col mx-12 gap-1">
			<div className="flex mt-3 justify-between">
				...
				<div className="flex">
					...
					<img src={united} alt="English Flag" className="h-[30px] pl-2" />
			...
			/>
			<h1 className="text-2xl text-gray-300 m-auto mt-6">or</h1>
			...
			{dataLoading && (
				<div className="absolute z-20 inset-0 bg-black bg-opacity-70">
					<TailSpin
						strokeWidth={5}
						speed={0.95}
						className="h-[80px] z-20 w-[80px] absolute top-[45%] left-[50%] rounded-full"
						stroke="#7e22ce"
					/>
				</div>
			)}
